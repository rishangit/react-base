  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        testpath: path.resolve('src/application/modules/default/test'),
        httpCall: path.resolve('src/system/default/httpCall'),
        'app/default': path.resolve('src/application/modules/default'),
